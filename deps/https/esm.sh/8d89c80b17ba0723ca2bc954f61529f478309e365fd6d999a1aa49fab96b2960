import { JoinColumnOptions } from "../decorator/options/JoinColumnOptions.d.ts";
import { RelationType } from "../metadata/types/RelationTypes.d.ts";
import { JoinTableMultipleColumnsOptions } from "../decorator/options/JoinTableMultipleColumnsOptions.d.ts";
...
import { JoinTableOptions } from "../decorator/options/JoinTableOptions.d.ts";
