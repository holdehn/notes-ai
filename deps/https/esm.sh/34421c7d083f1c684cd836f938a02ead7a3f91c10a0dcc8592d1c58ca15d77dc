import { BaseConnectionOptions } from "../../connection/BaseConnectionOptions.d.ts";
import { SpannerConnectionCredentialsOptions } from "./SpannerConnectionCredentialsOptions.d.ts";
/**
