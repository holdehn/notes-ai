...
import { SaveOptions } from "./SaveOptions.d.ts";
import { RemoveOptions } from "./RemoveOptions.d.ts";
...
import { UpsertOptions } from "./UpsertOptions.d.ts";
...
export declare class Repository<Entity extends ObjectLiteral> {
     ...
     */
    get metadata(): import("../index.d.ts").EntityMetadata;
