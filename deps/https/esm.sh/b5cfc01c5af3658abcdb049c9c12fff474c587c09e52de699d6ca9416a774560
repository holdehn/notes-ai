import { RelationType } from "./types/RelationTypes.d.ts";
...
import { RelationMetadataArgs } from "../metadata-args/RelationMetadataArgs.d.ts";
import { DeferrableType } from "./types/DeferrableType.d.ts";
import { OnUpdateType } from "./types/OnUpdateType.d.ts";
import { OnDeleteType } from "./types/OnDeleteType.d.ts";
import { PropertyTypeFactory } from "./types/PropertyTypeInFunction.d.ts";
/**
