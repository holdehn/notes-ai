import { EntityManager } from "./EntityManager.d.ts";
import { EntityTarget } from "../common/EntityTarget.d.ts";
import { ObjectLiteral } from "../common/ObjectLiteral.d.ts";
import { MongoQueryRunner } from "../driver/mongodb/MongoQueryRunner.d.ts";
import { FindManyOptions } from "../find-options/FindManyOptions.d.ts";
import { QueryDeepPartialEntity } from "../query-builder/QueryPartialEntity.d.ts";
import { InsertResult } from "../query-builder/result/InsertResult.d.ts";
import { UpdateResult } from "../query-builder/result/UpdateResult.d.ts";
import { DeleteResult } from "../query-builder/result/DeleteResult.d.ts";
import { EntityMetadata } from "../metadata/EntityMetadata.d.ts";
import { BulkWriteResult, AggregationCursor, Collection, FindCursor, Document, AggregateOptions, AnyBulkWriteOperation, BulkWriteOptions, Filter, CountOptions, IndexSpecification, CreateIndexesOptions, IndexDescription, DeleteResult as DeleteResultMongoDb, DeleteOptions, CommandOperationOptions, FindOneAndDeleteOptions, FindOneAndReplaceOptions, UpdateFilter, FindOneAndUpdateOptions, RenameOptions, ReplaceOptions, UpdateResult as UpdateResultMongoDb, CollStats, CollStatsOptions, ChangeStreamOptions, ChangeStream, UpdateOptions, ListIndexesOptions, ListIndexesCursor, OptionalId, InsertOneOptions, InsertOneResult, InsertManyResult, UnorderedBulkOperation, OrderedBulkOperation, IndexInformationOptions, ObjectId, FilterOperators } from "../driver/mongodb/typings.d.ts";
import { DataSource } from "../data-source/DataSource.d.ts";
import { MongoFindManyOptions } from "../find-options/mongodb/MongoFindManyOptions.d.ts";
import { MongoFindOneOptions } from "../find-options/mongodb/MongoFindOneOptions.d.ts";
import { FindOptionsSelect, FindOptionsSelectByString } from "../find-options/FindOptionsSelect.d.ts";
