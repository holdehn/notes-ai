...
export default function AssignmentDetailSidebar({ avatar }: Props) {
  ...
  return (
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:w-20 lg:block lg:overflow-y-auto lg:bg-blue-950 lg:pb-4">
